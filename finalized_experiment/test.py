...
from finalized_experiment.train import get_data
from finalized_experiment.model1NN import ModelAttention
...
def test_model(model, dataloader, model_name, mode="Test"):
    ...
    print(f"{mode} {model_name} accuracy: {overall_accuracy:.4f}")
