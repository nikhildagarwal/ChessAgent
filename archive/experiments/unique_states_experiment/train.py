...
import numpy as np
from NeuralNetworkAttention import ModelAttentionBatchnormDropout
...
if __name__ == "__main__":
    ...
    train_loader = DataLoader(train_dataset, batch_size=128, shuffle=False, generator=generator)
    test_loader = DataLoader(test_dataset, batch_size=64, shuffle=False, generator=generator)

    model = ModelAttentionBatchnormDropout()
